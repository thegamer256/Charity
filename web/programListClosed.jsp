<%-- 
    Document   : programListClosed
    Created on : Mar 30, 2023, 2:31:00 AM
    Author     : LE ANH TUAN
--%>
...
<div class="page-header">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>Closed Programs</h2>
            </div>
            <div class="col-12">
                <a href="home">Home</a>
                <a href="">Closed Programs List</a>
            </div>
        </div>
    </div>
</div>
