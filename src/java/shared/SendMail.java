...
public class SendMail {
    ...
    public static void main(String[] args) {
        SendMail.sendConfirmEmail("success","tuanlade160625@fpt.edu.vn", "CONFIRM DONATING", "We receive a request that you donate 7000 dollars for the project xxx pllease confirm it by the OTP", "Thanks for being part of us", OTPGenerate.generateOTP());
    }
}
